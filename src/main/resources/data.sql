INSERT INTO theme (id, name, description, thumbnail, price) VALUES
    (1, 'Theme 1', 'Popular theme rank 1', 'https://example.com/theme-1.png', 40000),
    (2, 'Theme 2', 'Popular theme rank 2', 'https://example.com/theme-2.png', 40000),
    (3, 'Theme 3', 'Popular theme rank 3', 'https://example.com/theme-3.png', 40000),
    (4, 'Theme 4', 'Popular theme rank 4', 'https://example.com/theme-4.png', 40000),
    (5, 'Theme 5', 'Popular theme rank 5', 'https://example.com/theme-5.png', 40000),
    (6, 'Theme 6', 'Popular theme rank 6', 'https://example.com/theme-6.png', 40000),
    (7, 'Theme 7', 'Popular theme rank 7', 'https://example.com/theme-7.png', 40000),
    (8, 'Theme 8', 'Popular theme rank 8', 'https://example.com/theme-8.png', 40000),
    (9, 'Theme 9', 'Popular theme rank 9', 'https://example.com/theme-9.png', 40000),
