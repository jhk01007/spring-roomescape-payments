...
public class TossClientConfig {
    ...
    public RestClient tossRestClient(
        ...
        return RestClient.builder()
                .baseUrl(baseUrl)
                .requestFactory(getRequestFactory(connectTimeoutMs, readTimeoutMs))
                .defaultHeader(HttpHeaders.AUTHORIZATION, "Basic " + basic)
                .build();
    }

    private static SimpleClientHttpRequestFactory getRequestFactory(int connectTimeoutMs, int readTimeoutMs) {
